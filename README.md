...
> **📖 路径 B（数据科学家/PM）**：从 📖 文字解释层读起，按问题查阅
> **📘📖 路径 C（研究者）**：两层交叉看，先找数字再追原理
...
2. **文字层（📖）独立可读**：只看原理，深入理解"为什么"
3. **两层互补**：文字层解释代码层数字背后的原理，代码层验证文字层的结论
4. **路径多样**：3 类读者（应用工程师 / 数据科学家 / 研究者）各取所需
