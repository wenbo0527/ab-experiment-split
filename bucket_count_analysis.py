...
def bucket_count_analysis() -> None:
    ...
    print("\n 数学推导：")
    print("   偏差下界 = z / sqrt(N/G) = z / sqrt(k × B/G)")
    print("   即 偏差下界² = z² × G / (k × B)")
    print("   =>  k = z² × G / (偏差下界² × B)")
...
def answer_practical_questions() -> None:
    ...
    print("   k = 5000 / 1000 = {5000/1000} 人/桶")
    ...
    print("   即 10 组实验需要总流量 {min_n * 10:,} 用户")

    print("\n【问题 4】每桶 5 人这个数字怎么提高到 1% 偏差？")
    print("   路径 A: 增加总流量 N")
    print("   路径 B: 减少组数 G（粗粒度分流）")
    print("   路径 C: 放弃纯实时，改用批量预分桶（蛇形分配）")
